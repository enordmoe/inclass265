...
Since time here is represented in minutes and seconds, it's difficult to deal with. Instead, we should convert our time periods to *durations* which have exact lengths in seconds. 
