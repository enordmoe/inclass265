...
1.  As we noted above, certain characters are reserved. If we want to actually reference them in a regular expression, either put them within a bracket, or use a double forward slash to "escape" them.
...
3.  See the summary of regular expressions posted on [here](http://people.kzoo.edu/enordmoe/math265/regExp.pdf). This is a much more manageable (but still extensive!) set of regexp expressions as a more user-friendly alternative to the RStudio stringr Cheat Sheet.
